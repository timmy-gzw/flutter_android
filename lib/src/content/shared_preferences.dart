...
abstract class SharedPreferences {
  ...
  ///
  /// See: https://developer.android.com/reference/android/content/SharedPreferences#getBoolean(java.lang.String,%20boolean)
  bool getBoolean(String key, [bool defaultValue = false]) => get(key, defaultValue);
  ...
  double getFloat(String key, [double defaultValue = 0.0]) => get(key, defaultValue);
  ...
  int getInt(String key, [int defaultValue = 0]) => get(key, defaultValue);
  ...
  int getLong(String key, [int defaultValue = 0]) => get(key, defaultValue);
...
// Set<String> getStringSet(String key, [Set<String> defaultValue = Set<String>()]) =>
...
class _SharedPreferences extends SharedPreferences {
  ...
  Future<SharedPreferences> load() async {
    ...
    _cache = (await _channel.invokeMethod('getAll', request) as Map<dynamic, dynamic>)
        .cast<String, dynamic>();
    return this;
  }
